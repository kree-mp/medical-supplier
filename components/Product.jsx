    ...
    <sections className=" w-full md:px-20 items-center px-6 py-20 flex flex-col space-y-10">
      <div className="space-y-5 text-center">
        ...
        <p className="text-secondary">
          Advanced diagnostic tools such as stethoscopes, blood pressure
        ...
        {Products.map((item, index) => {
          return (
            <div
              ...
              key={index}
            >
              <div className="bg-slate-200 text-sky-700 w-10 h-10 flex justify-center rounded-md items-center">
                {item.logo}
              </div>
              <div>
